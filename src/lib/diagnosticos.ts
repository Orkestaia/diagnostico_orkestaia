...
export const COLUMNAS_VISITA =
  "id, token, estado, sector, subsector, tipo_negocio, empresa, contacto_nombre, fecha_reunion, hora_reunion, lugar_reunion, respuestas_previo, respuestas_visita, procesos, visita_cerrada_at, config_version";
