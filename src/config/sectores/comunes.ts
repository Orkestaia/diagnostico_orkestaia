...
export const PREGUNTAS_I: Pregunta[] = [
  ...
  },
  {
    ...
    opciones: [
      ...
      { etiqueta: "Comercial" },
      { etiqueta: "Otro", pideCual: "¿Cuál es tu papel?" },
    ],
  },
...
export const PREGUNTAS_IV: Pregunta[] = [
  {
    ...
    tipo: "multi",
    // Las opciones genéricas piden el nombre concreto (decisión de Aitor, 18-sep).
    opciones: [
      { etiqueta: "Excel u hojas de cálculo" },
      { etiqueta: "Google Workspace" },
      { etiqueta: "Microsoft 365" },
      { etiqueta: "Un CRM", pideCual: "¿Cuál? Por ejemplo, HubSpot" },
      { etiqueta: "Programa de gestión o ERP", pideCual: "¿Cuál? Por ejemplo, Holded, Sage o A3" },
      { etiqueta: "Software de mi sector", pideCual: "¿Cuál? El nombre del programa" },
      { etiqueta: "WhatsApp Business" },
      { etiqueta: "Agenda o reservas online", pideCual: "¿Cuál? Por ejemplo, Doctoralia o CoverManager" },
      { etiqueta: "Programa de facturación", pideCual: "¿Cuál? Por ejemplo, Holded o Quipu" },
      { etiqueta: "Nada en especial" },
    ],
  },
  {
